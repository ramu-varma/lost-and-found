...
const LostItems = () => {
    ...
    const fetchItems = async (search = '') => {
        ...
        try {
            ...
            const lostItems = data.items.filter(item => item.type === 'LOST');
            setItems(lostItems);
            setLoading(false);
        } catch (error) {
            console.error(error);
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-16 mb-12 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-slate-400 text-lg mb-10 font-medium">
                        Search through our community database to find your missing items.
                    </p>
                    ...
                    <form onSubmit={handleSearch} className="relative group max-w-2xl mx-auto">
                        ...
                        <input
                            ...
                            className="w-full pl-14 pr-32 py-5 bg-white border-2 border-slate-200 rounded-2xl text-black placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-primary/20 transition-all font-black"
                            value={keyword}
                            onChange={(e) => setKeyword(e.target.value)}
                        />
                        <button
                            type="submit"
                            className="absolute right-3 top-3 bottom-3 bg-primary text-white px-8 rounded-xl font-black text-sm hover:bg-primary-dark transition-all shadow-lg shadow-primary/20"
                        >
                            Search
                        </button>
                    </form>
